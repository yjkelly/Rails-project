...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { description: @destination.description, name: @destination.name, picture: @destination.picture }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { description: @destination.description, name: @destination.name, picture: @destination.picture }
    assert_redirected_to destination_path(assigns(:destination))
  end
